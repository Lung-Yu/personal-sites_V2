...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: {
      en: 'Product Owner and lead developer of an enterprise-grade vulnerability management platform built on microservices architecture. Features automated Fortify scan report parsing, risk workflow management, role-based access control, GitLab CI token integration, and an AI-powered security consultant via RAG. Migrated to GCP (Cloud Run) with Terraform IaC.',
      zh: '以 Product Owner 兼主力開發者角色，主導建構企業級弱點管理平台（微服務架構）。功能涵蓋 Fortify 掃描報告自動解析、風險處理工作流程、角色權限管理、GitLab CI Token 整合，及 RAG 驅動的 AI 資安顧問模組。已遷移至 GCP Cloud Run 並以 Terraform IaC 管理。',
    },
    language: 'Python',
    stars: 0,
  ...
  },
  {
    ...
    description: {
      en: 'Self-service web portal for source code security scanning that reduced repetitive manual operations by 80%. Containerised with Docker, integrated with enterprise CI/CD pipelines, and deployed to production for multiple enterprise clients.',
      zh: '自助式原碼安全檢測入口網站，降低 80% 重複性人工操作。以 Docker 容器化，整合企業 CI/CD 流水線，已正式供多家企業客戶上線使用。',
    },
    language: 'Python',
    stars: 0,
    url: 'https://github.com/Lung-Yu',
  ...
  },
  {
    ...
    description: {
      en: 'R&D project for SCA (Software Composition Analysis) tooling using microservice architecture and gRPC for high-throughput processing. Supports both CycloneDX and SPDX SBOM formats for open-source dependency risk assessment.',
      zh: '以微服務架構與 gRPC 開發的 SCA（軟體組成分析）工具研究專案，支援 CycloneDX 與 SPDX 兩種 SBOM 格式，用於開源相依套件風險評估。',
    },
    language: 'Python',
    stars: 0,
    url: 'https://github.com/Lung-Yu',
